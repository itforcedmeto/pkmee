...
#define B_AFFECTION_MECHANICS           FALSE       // jd changed - In Gen6+, there's a stat called affection that can trigger different effects in battle. From LGPE onwards, those effects use friendship instead.
...
#define B_TRAINER_MON_RANDOM_ABILITY    TRUE      // jd changed - If this is set to TRUE a random legal ability will be generated for a trainer mon
...
#define B_OVERWORLD_FOG                 GEN_7 // jd changed - In Gen8+, overworld Fog summons Misty Terrain in battle. In Gen4 only, overworld Fog summons the unique fog weather condition in battle.
