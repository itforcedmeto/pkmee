...
#define FLAG_ITEM_ROUTE_105_ICYWIND                                 0x493 // Unused Flag
#define FLAG_RECEIVED_TM_PROTECT                                    0x494 // Unused Flag
#define FLAG_ITEM_SKY_PILLAR_DRAGONPULSE                            0x495 // Unused Flag
#define FLAG_ITEM_MAGMA_HIDEOUT_FLAMETHROWER                        0x496 // Unused Flag
#define FLAG_ITEM_SAFARI_ZONE_DAZZLINGGLEAM                         0x497 // Unused Flag
